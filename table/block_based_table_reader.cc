...
template <class TBlockIter, typename TValue>
void BlockBasedTableIterator<TBlockIter, TValue>::Seek(const Slice& const_target) {
...
void BlockBasedTableIterator<TBlockIter, TValue>::InitRangeTombstone(const Slice& target) {
  ...
  auto tombstone = range_del_agg_->GetTombstone(target, file_meta_->fd.largest_seqno);
...
template <class TBlockIter, typename TValue>
std::string BlockBasedTableIterator<TBlockIter, TValue>::tombstone_internal_start_key() const {
...
template <class TBlockIter, typename TValue>
std::string BlockBasedTableIterator<TBlockIter, TValue>::tombstone_internal_end_key() const {
  std::string internal_key;
